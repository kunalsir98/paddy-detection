...
class DataTransformationConfig:
    prerocessor_obj_file_path=os.path.join('artifacts','preprocessor.pkl')
...
class DataTransformation:
    ...
    def get_data_transformation_obj(self):
       ...
       'Relative Humidity_D91_D120', 'Trash(in bundles)']
            ...
            logging.info('Exception Occured at Data Transformaation Stage')
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            save_object(self.data_transformation_config.prerocessor_obj_file_path,
            ...
            return(
                train_arr,
                test_arr,
                self.data_transformation_config.prerocessor_obj_file_path
            )
